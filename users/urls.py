...
from .views import (activate, activation_complete, register,
                    registration_closed, registration_complete, hswprofile)
...
urlpatterns = [
    ...
    url(r'^crmtest/$', crmviews.crm_main),
    #url(r'^logout/$', logout, {'template_name': 'users/logout.html','extra_context':{'pagename':'users_logout'}}, name='users_logout'),
    ...
    url(r'^hswprofile$', hswprofile, name='login_page'),
]
